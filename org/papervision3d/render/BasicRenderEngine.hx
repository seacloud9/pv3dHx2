 ...
 */	
class BasicRenderEngine extends AbstractRenderEngine implements IRenderEngine
{
	/**
	...
	/** @private */
	private var renderDoneEvent:RendererEvent;
	/** @private */
	private var projectionDoneEvent:RendererEvent;
	/** @private */
	private var renderStatistics:RenderStatistics;
	/** @private */
	private var renderList:Array<Dynamic>;
	/** @private */
	 ...
	 * @see #renderScene
	 */
	public function renderLayers(scene:SceneObject3D, camera:CameraObject3D, viewPort:Viewport3D, layers:Array<Dynamic>=null):RenderStatistics
	{
		//Update the renderSessionData object.
		renderSessionData.scene=scene;
		renderSessionData.camera=camera;
	...
	/** @private */
	private function doRender(renderSessionData:RenderSessionData, layers:Array<Dynamic>=null):RenderStatistics
	{
		stopWatch.reset();
		stopWatch.start();
