...
class LightMatrix
{
	...
	private static var _targetPos:Float3D=new Float3D();
	private static var _lightPos:Float3D=new Float3D();
	private static var _lightDir:Float3D=new Float3D();
	private static var _lightUp:Float3D=new Float3D();
	private static var _lightSide:Float3D=new Float3D();
	
	protected static var UP:Float3D=new Float3D(0, 1, 0);
	...
	public static function getLightMatrix(light:LightObject3D, object:DisplayObject3D, renderSessionData:RenderSessionData, objectLightMatrix:Matrix3D):Matrix3D
	{
		...
		// inlined:Float3D.cross(UP, _lightDir);
		...
		// inlined:Float3D.cross(_lightDir, dir_x);
