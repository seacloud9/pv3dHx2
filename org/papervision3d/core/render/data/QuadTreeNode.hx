...
public final class QuadTreeNode
{
	...
	private function render_other(limit:Float, renderSessionData:RenderSessionData, graphics:Graphics):Void
	{
		if(lefttopFlag)
	...
	*/
	public var onlysourceFlag:Bool=true;
	...
	*/
	 ...
	 */
	public function QuadTreeNode(xdiv:Float, ydiv:Float, width:Float, height:Float, level:Int, parent:QuadTreeNode=null, maxLevel:Int=4)
	{
		this.level=level;
		this.xdiv=xdiv;
		this.ydiv=ydiv;
	...
	*/
	public function reset(xdiv:Float, ydiv:Float, width:Float, height:Float, maxLevel:Int):Void
	{
		this.xdiv=xdiv;
		this.ydiv=ydiv;
		halfwidth=width / 2;
	 ...
	 */
	public function render(limit:Float, renderSessionData:RenderSessionData, graphics:Graphics):Void
	{
